...
export default function CategoriesPage(): React.JSX.Element {
  ...
  // dashboard's `ProductsSummary` uses — not a fabricated "Total Earning" figure like Sneat's category
  // cards show (no per-order revenue-by-category aggregation exists), so this is what's honestly derivable.
