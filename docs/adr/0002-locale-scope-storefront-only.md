...
Lưu ý: quyết định này **không** ảnh hưởng tới việc Content Editor vẫn nhập được Localized Text đa ngôn ngữ cho Product/CMS content (xem glossary.md — `Localized Text`) — đó là dữ liệu khách hàng thấy trên storefront, khác với ngôn ngữ của giao diện Admin/CMS dùng để nhập liệu.
