...
- **Access token lưu `localStorage`/`sessionStorage`**: bị từ chối, vi phạm trực tiếp nguyên tắc bảo mật đã chốt trong [`../../FE/FE-ARCHITECTURE.md`](../../FE/FE-ARCHITECTURE.md) §11 (không lưu token dài hạn ở `localStorage`).
