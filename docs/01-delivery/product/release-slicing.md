...
Roadmap theo phase trong [`../FE/FE.md`](../FE/FE.md) §10 rất tốt cho triển khai kỹ thuật. File này thêm một lớp nhìn theo phát hành sản phẩm: cái gì chặn launch, cái gì nên theo sau, và cái gì có thể để sau nữa.
...
Các mục này **không** phủ định dependency kỹ thuật trong [`../FE/FE.md`](../FE/FE.md) §10. Ví dụ, Search cơ bản chặn Launch 1, nhưng predictive search, tuning relevance, và các tối ưu sâu hơn vẫn có thể đi sau nếu nền tảng đã đủ cho luồng MVP.
...
- [`../FE/FE.md`](../FE/FE.md) §10 vẫn là nguồn chính cho thứ tự kỹ thuật.
