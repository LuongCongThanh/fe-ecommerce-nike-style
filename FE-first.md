...
## 2.1. Front-end trước nhưng không bỏ qua Back-end design
...
Không nên viết toàn bộ Front-end dựa trên dữ liệu tùy ý rồi mới thiết kế Back-end, vì điều đó dễ dẫn đến:
...
Mỗi section không nên hard-code nội dung trực tiếp.
...
Không nên lưu toàn bộ filter chỉ trong Zustand vì:
...
Không nên lưu size và color độc lập mà không xác định được SKU cuối cùng.
...
* UI không chỉ ẩn button mà API sau này vẫn phải enforce quyền.
...
Không chỉ tham chiếu product hiện tại vì sản phẩm có thể thay đổi sau đó.
...
Mục tiêu MVP không phải clone toàn bộ Nike, mà là hoàn thành một vertical slice chất lượng cao:
